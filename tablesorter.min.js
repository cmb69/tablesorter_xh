...
(function () {
    if (typeof document.visibilityState === "undefined" || typeof document.attachEvent !== "undefined") {
        return;
    }

    var TABLESORTER = JSON.parse(document.querySelector("[data-tablesorter-config]").dataset.tablesorterConfig);
